# tananda23-live-base.ks
#
# Defines the basics for all kickstarts in the tananda23-live branch
...
###############################################################################
%post --nochroot
install -p $INSTALL_ROOT/usr/share/licenses/*-release/* $LIVE_ROOT/
